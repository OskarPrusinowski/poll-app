    ...
    <div v-show="show" class="example">
        <div class="input_row">
           ...
           <div class="input_row"> <label for="login">Login</label>
            ...
            <div class="input_row"><label for="password">Hasło</label>
            <input type="password" name="password" v-model="user.password"></div>
            <div class="input_row"><label for="password_confirmation">Potwierdź hasło</label>
            <input type="password" name="password_confirmation" v-model="user.password_confirmation"></div>
            <div class="input_row">
